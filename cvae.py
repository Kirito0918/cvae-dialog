...
parser.add_argument('--model_path', dest='model_path', default='log/run1570265897/001000000105756.model', type=str, help='载入模型位置')  #
...
parser.add_argument('--max_epoch', dest='max_epoch', default=4, type=int, help='最大训练epoch')
